...
<div class="row" style="margin-bottom=-1em; margin-left:0.2em">
  <div class="column2" style="width:46%">
  <div class="container">
    <img class="hover_box" style="width:93%" src="/images/smarticleSR.JPG" alt="A supersmarticle" >
    <div class="caption" style="width:93%; bottom:3%"><p>Individually immotile smarticles are able to collectively locomote.</p></div>
  </div>
</div>

<div class="column2" style="width:49%">
  <div class="container">
